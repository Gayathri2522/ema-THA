...
# Transformer # Use SentenceTransformer module to use Hugging face Model
...
def main():
    load_dotenv()
    st.set_page_config(page_title="Ema Assignment", page_icon=":books:")
    ...
    st.header("Ema's Natural Query Agent :computer:")
